export const initialChecklists = {
    ...
    'ESPECIFICOS': [
      { id: '1', text: 'Bebés', completed: false, subChecklist: [
        { id: '1.1', text: 'Lata de Leche', completed: false },
        { id: '1.2', text: 'Biberón', completed: false },
        { id: '1.3', text: 'Papilla', completed: false },
        { id: '1.4', text: 'Pañales descartables', completed: false },
        { id: '1.5', text: 'Juego de cubiertos para niños', completed: false },
        { id: '1.6', text: 'Ropa de cambio', completed: false },
        { id: '1.7', text: 'Medicamentos', completed: false },
        { id: '1.8', text: 'Juguetes', completed: false },
      
      ]},
      { id: '2', text: 'Adulto mayor', completed: false, subChecklist: [
        { id: '2.1', text: 'Pañales geriatricos', completed: false },
        { id: '2.2', text: 'Ropa de cambio', completed: false },
        { id: '2.3', text: 'Medicamentos', completed: false },
      ]},
  ...
  export const cards = [
    { title: 'COMUNICACIÓN', image: imageSource.basic },
    ...
    { title: 'BOTIQUIN DE PRIMEROS AUXILIOS', image: imageSource.other2 },
